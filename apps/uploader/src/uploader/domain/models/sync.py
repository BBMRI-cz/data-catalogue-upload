...
from uploader.domain.models.patient import Clinical, Personal
from uploader.domain.models.radiology import ImagingStudy
from uploader.domain.models.sample import Sample
